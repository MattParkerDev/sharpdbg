...
public static class TestExtensions
{
	public static void AssertInstanceThisInstanceVariables(this DebugProtocolHost debugProtocolHost, int variablesReference)
	{
		...
		variables.Should().BeEquivalentTo(expectedVariables);
		debugProtocolHost.AssertInstanceThisStaticVariables(variables.Single(s => s.Name == "Static members").VariablesReference);
	}
	...
	public static void AssertInstanceThisStaticVariables(this DebugProtocolHost debugProtocolHost, int variablesReference)
	{
		...
		[
			...
			new() { Name = "StaticClassProperty", EvaluateName = "StaticClassProperty", Value = "{DebuggableConsoleApp.MyClass2}", Type = "DebuggableConsoleApp.MyClass2", VariablesReference = 13 },
			...
			new() { Name = "_utcNow", EvaluateName = "_utcNow", Value = "{System.DateTime}", Type = "System.DateTime", VariablesReference = 25 },
		];
