...
public class Variables2Tests(ITestOutputHelper testOutputHelper)
{
	...
	public async Task SyncMethod_VariablesClass_VariablesRequest_ReturnsCorrectVariables()
	{
		...
		var expectedLocalDateTime = new DateTime(2026, 6, 13, 5, 42, 39).ToString();
		...
		[
			...
			new() { VariablesReference = 9,  Name = "localClass",           	EvaluateName = "localClass",           		Value = "{DebuggableConsoleApp.TestClass}",			Type = "DebuggableConsoleApp.TestClass" },
				...
				new() { VariablesReference = 16, Name = "localDynamic",         	EvaluateName = "localDynamic",         		Value = "241",                                  	Type = "System.Int32" },
				new() { VariablesReference = 17, Name = "localAnonymous",       	EvaluateName = "localAnonymous",       		Value = "{{ Id = 1, Name = Anonymous }}",         	Type = "<>f__AnonymousType0<int, string>" },
				new() { VariablesReference = 18, Name = "localDateTime",        	EvaluateName = "localDateTime",        		Value = expectedLocalDateTime,						Type = "System.DateTime" },
				new() { VariablesReference = 19, Name = "localGuid",            	EvaluateName = "localGuid",            		Value = "27de5b68-af24-4e59-a785-dde52e2ea7af",		Type = "System.Guid" },
		];
